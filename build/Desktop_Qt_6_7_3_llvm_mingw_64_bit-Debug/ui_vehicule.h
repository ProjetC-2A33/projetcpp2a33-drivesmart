...
public:
    ...
    void setupUi(QWidget *Vehicule)
    {
        ...
        groupBox_3->setGeometry(QRect(0, 0, 1471, 61));
...
"border-radius:10px;"));
        ...
        groupBox_4->setGeometry(QRect(439, 500, 1041, 331));
...
""));
        ...
        QR_CODE_2 = new QPushButton(groupBox_4);
        QR_CODE_2->setObjectName("QR_CODE_2");
        QR_CODE_2->setGeometry(QRect(800, 20, 131, 41));
        QFont font2;
        font2.setPointSize(16);
        QR_CODE_2->setFont(font2);
        QR_CODE_2->setStyleSheet(QString::fromUtf8("background-color:#ffce00;\n"
"color:#002157;\n"
"border-radius:10px;"));
        groupBox_7 = new QGroupBox(Vehicule);
        groupBox_7->setObjectName("groupBox_7");
        groupBox_7->setGeometry(QRect(440, 68, 1041, 411));
...
"border-radius:10px;"));
        ...
        QR_CODE = new QPushButton(groupBox_7);
        QR_CODE->setObjectName("QR_CODE");
        QR_CODE->setGeometry(QRect(1040, 20, 141, 41));
        QR_CODE->setFont(font1);
        QR_CODE->setStyleSheet(QString::fromUtf8("background-color:#ffce00;\n"
"color:#002157;\n"
"border-radius:10px;"));
        groupBox_10 = new QGroupBox(Vehicule);
        groupBox_10->setObjectName("groupBox_10");
        groupBox_10->setGeometry(QRect(0, 68, 421, 761));
...
""));
        ...
        etatmainComboBox = new QComboBox(groupBox_10);
        etatmainComboBox->addItem(QString());
        etatmainComboBox->addItem(QString());
        etatmainComboBox->addItem(QString());
        etatmainComboBox->setObjectName("etatmainComboBox");
        etatmainComboBox->setGeometry(QRect(220, 460, 181, 41));
        etatmainComboBox->setFont(font1);
        etatmainComboBox->setStyleSheet(QString::fromUtf8("background-color:white;\n"
"border-radius:5px;\n"
"border:2px solid #ffce00;\n"
""));
    ...
    void retranslateUi(QWidget *Vehicule)
    {
        ...
        QR_CODE_2->setText(QCoreApplication::translate("Vehicule", "QR CODE", nullptr));
        ...
        QR_CODE->setText(QCoreApplication::translate("Vehicule", "QR_CODE", nullptr));
        ...
        etatmainComboBox->setItemText(0, QCoreApplication::translate("Vehicule", "--------------", nullptr));
        etatmainComboBox->setItemText(1, QCoreApplication::translate("Vehicule", "assur\303\251", nullptr));
        etatmainComboBox->setItemText(2, QCoreApplication::translate("Vehicule", "non assur\303\251", nullptr));
